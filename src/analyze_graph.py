...
def analyze_graph(path, name, directed=False):
    ...
    # Clustering coefficient (approx for large graphs)
    ...
    plt.close()
    print(f"Degree distribution plot saved for {name}")

    end_time = time.time()
    print(f"Analysis of {name} completed in {end_time-start_time:.2f} seconds")
...
if __name__ == "__main__":
    results = []
    # Replace these with your actual filenames in data folder
